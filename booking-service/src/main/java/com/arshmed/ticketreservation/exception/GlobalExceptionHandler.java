...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> StartExceptionHandler(BookingException ex){
    ...
    @ResponseBody
    public final ResponseEntity<ErrorMessage> handleDuplicateKeyException(
            DataIntegrityViolationException exception) {
        ErrorType errorType = DATA_INTEGRATION_VIOLATION_EXCEPTION;
        return new ResponseEntity<>(createErrorMessage(exception,errorType), errorType.getHttpStatus());
    }
    ...
    public final ResponseEntity<ErrorMessage> handleMethodArgumentNotValidException(
        ...
        exception
                .getBindingResult()
                .getFieldErrors()
                .forEach(e -> fields.add(e.getDefaultMessage()));
