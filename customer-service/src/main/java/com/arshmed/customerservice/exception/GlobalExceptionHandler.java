...
import static com.arshmed.customerservice.exception.ErrorType.BAD_REQUEST_ERROR;
import static com.arshmed.customerservice.exception.ErrorType.INVALID_USER;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> StartExceptionHandler(CustomerException ex){
